...
class ClientControllerTest {
	...
	void before() throws Exception{
		...
		MvcResult mvcResult = mock
				.perform(MockMvcRequestBuilders.post(uri).content(json.toJSONString())
	...
	void shouldTakeAToken() throws Exception {
		...
		mock.perform(MockMvcRequestBuilders.post(uri).content(json.toJSONString()).contentType(MediaType.APPLICATION_JSON))
	...
	void shouldCreateAClient() throws Exception {
		...
		mock.perform(MockMvcRequestBuilders.post(uri).content(json.toJSONString()).header("Authorization",
				"Bearer "+ token)
